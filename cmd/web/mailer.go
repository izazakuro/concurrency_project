...
// Function to listen for messages on the Mail Channel
...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	...
	fomattedMessage := tpl.String()
	fomattedMessage, err = m.inlineCSS(fomattedMessage)
	if err != nil {
		return "", nil
	}

	return fomattedMessage, nil
}
